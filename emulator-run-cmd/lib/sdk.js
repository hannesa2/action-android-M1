...
class BaseAndroidSdk {
    ...
    installEmulatorPackage(api, tag, abi, verbose) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, exec_with_result_1.execIgnoreFailure)(`bash -c \\\"${this.androidHome()}/cmdline-tools/latest/bin/sdkmanager emulator platform-tools 'system-images;android-${api};${tag};${abi}'${args}"`);
        });
    }
    installPlatform(api, verbose) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, exec_with_result_1.execIgnoreFailure)(`bash -c \\\"${this.androidHome()}/cmdline-tools/latest/bin/sdkmanager 'platforms;android-${api}'${args}"`);
        });
    }
    createEmulator(name, api, tag, abi, hardwareProfile) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, exec_with_result_1.execIgnoreFailure)(`bash -c \\\"echo -n no | ${this.androidHome()}/cmdline-tools/latest/bin/avdmanager create avd -n ${name} --force --package \\\"system-images;android-${api};${tag};${abi}\\\" --tag ${tag}\" ${additionalOptions}`);
